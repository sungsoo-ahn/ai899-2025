...
authors:
  - name: Sungsoo Ahn
    ...
    affiliations:
      name: KAIST, Graduate School of AI

# must be the exact same name as your blogpost
# add the corresponding file in assets/bibliography/2025-02-24-distill-example.bib  
bibliography: 2025-02-24-distill-example.bib  
